    ...
    <body>
        ...
        <div class="done">
            <form action="/sign-up/add" method="post">
                ...
                <input type="submit" class="button" onclick="window.location.href='<?php echo e(url('/login/view')); ?>'" name="submit"
                    value="Daftar">
...
</html><?php /**PATH C:\xampp\htdocs\applications\T-zens\resources\views/sign-up.blade.php ENDPATH**/ ?>