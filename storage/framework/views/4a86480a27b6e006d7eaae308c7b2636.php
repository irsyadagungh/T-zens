...
<body>
    ...
    <section class="sec-3" id="acara">
        ...
        <?php $__currentLoopData = $acara; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="card" onclick="window.location.href='<?php echo e(url('/acara/detil-acara')); ?>'">
                <img src="/assets/pics/"<?php echo e($value['foto']); ?>>
                <div class="teks">
                    <h5>
                    ...
                    <div class="content-1">
                        <p>waktu</p>
                        <p><?php echo e($value['waktu']); ?></p>
                    </div>
                    <div class="content-2">
                        <p class="type"><?php echo e($value['tipe_acara']); ?></p>
                        <p><?php echo e($value['subscription']); ?></p>
                    </div>
                </div>
            </div>
