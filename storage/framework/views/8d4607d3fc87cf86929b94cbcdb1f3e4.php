    ...
    <section class="home-3">
        <div class="content sec-3">
            ...
            <div data-aos="fade-up" data-aos-duration="1250" class="content-text sec-3">
                ...
                <p>Pilih skill apapun dan pelajari kapanpun. Dapatkan video materi terstruktur, modul praktik plus
                    webinar series rancangan
    ...
    <section class="home-4">
        <div data-aos="fade-up" data-aos-duration="1000" class="testimoni">
            ...
            <div class="testi-content">
                <h6>Testimoni</h6>
                <p class="testi-text">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Repudiandae magni
                    corporis quae iure eveniet laboriosam sapiente, molestias atque, praesentium ipsam illum ea suscipit
                    hic amet? Dicta eaque natus odit eum?</p>
            </div>
        </div>
        ...
        <div data-aos="fade-up" data-aos-duration="1500" class="testimoni">
            ...
            <div class="testi-content">
                ...
                <p class="testi-text">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Repudiandae magni
                    corporis quae iure
                    eveniet laboriosam sapiente, molestias atque, praesentium ipsam illum ea suscipit hic amet? Dicta
                    eaque natus odit
                    eum?</p>
            </div>
        </div>
...
<?php /**PATH C:\xampp\htdocs\applications\T-zens\resources\views/coba.blade.php ENDPATH**/ ?>