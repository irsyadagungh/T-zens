...
<body class="body">
    ...
    <nav>
        ...
        <ul>
            ...
            @else
                <li><a href="sign-up" class="button daftar">Daftar</a></li>
            @endif
        ...
        <section class="home-3" id="3">
            <div class="content sec-3">
                ...
                <div data-aos="fade-up" data-aos-duration="1250" class="content-text sec-3">
                    ...
                    <button class=" button btn-sec-3" onclick="window.location.href='{{ url('/acara') }}'">Lihat Ratusan
                        Acara</button>
                </div>
            </div>
            ...
            <div class="content sec-3">
                <div data-aos="fade-up" data-aos-duration="1000" class="content-text sec-3">
                    ...
                    <p>Pilih skill apapun dan pelajari kapanpun. Dapatkan video materi terstruktur, modul praktik plus
                        webinar series rancangan
                        para experts dari top companies.</p>
                    <button class=" button btn-sec-3" onclick="window.location.href='{{ url('/organisasi') }}'">Lihat
                        Ratusan Organisasi</button>
                </div>
